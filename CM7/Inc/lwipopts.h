...
/* BUGFIX: Spostato a 0x30005000 per evitare sovrapposizione con RX_POOL (che arriva fino a 0x30004980).
   Non si può rimuovere del tutto, altrimenti finisce in RAM_D1 e il MAC DMA smette di funzionare! */
